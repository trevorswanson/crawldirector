  ...
  return (
    <>
      ...
      {entity?.type === "FLOOR" && (() => {
        ...
        // startDay/collapseDay are the absolute days-since-collapse the floor
        // opened / collapses — anchors that let FLOOR_START / FLOOR_COLLAPSE
        // event times resolve to absolute days on the timeline (docs/adr/0008).
        const existingData =
          (entity.data as {
