...
Covers: completed M3 floor/timeline/graph/knowledge slices, the M4 AI
foundation (BYO-key storage, provider abstraction, first generator), M2 (review
pipeline), M1, M0, and the early design-language/shell work. Newer work (M5, the
M4 generator-expansion tail, the entity-kind registry, visibility
simplification) is still in PROGRESS.md.
